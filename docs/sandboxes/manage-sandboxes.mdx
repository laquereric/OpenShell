...
amount the sandbox can use. The VM driver applies them as the microVM vCPU
count and memory size. Millicores round up to whole vCPUs. Memory quantities
round up to MiB. VM sandboxes reject resource requests.
